...
function execute() {
    ...
    try{
        ...
        let output = YAML.parse(inputElement.value)
        let outputElement = document.getElementById("output")
        outputElement.innerHTML = JSON.stringify(output, undefined, 4)
        showOutput()
    } catch (error) {
        message.innerHTML = "Invalid YAML";
        hideOutput()
    }
    location.href = "#";
    location.href = "#jsonTitle"
}

function onYamlChange(){
    let inputElement = document.getElementById("input")
    inputElement.value = YAML.stringify(inputElement.value, 4)
}

function showOutput(){
    let outputElement = document.getElementById("outputBox")
